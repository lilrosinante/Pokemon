...
public class Pokedex {
    ...
    public Pokedex() {
        ...
        pokemonList.add(new Pokemon(6, "Turktok", Type.WATER, 140, 45, 20, 55, 60, attackList.get(2), attackList.get(5), false, false));
        ...
        pokemonList.add(new Pokemon(9, "Bisaflor", Type.GRASS, 140, 40, 20, 40, 50, attackList.get(0), attackList.get(15), false, false));
